...
export default function MobileBottomNav({ activeTab = 'explore' }: MobileBottomNavProps) {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
            <div
                style={{
                    background: 'rgba(250, 243, 229, 0.92)',
                    backdropFilter: 'blur(20px) saturate(180%)',
                    WebkitBackdropFilter: 'blur(20px) saturate(180%)',
                    borderTop: '1px solid color-mix(in srgb, var(--color-primary) 8%, transparent)',
                    ...
                    return (
                        ...
                        >
                            ...
                            <span
                                ...
                                style={{
                                    fontSize: '24px',
                                    color: isActive ? 'var(--color-primary)' : 'var(--color-ink-400)',
                                }}
                            >
                                {item.icon}
                            </span>
